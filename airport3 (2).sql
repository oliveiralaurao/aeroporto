...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/04/2025 às 06:31
...
(21, 'dede', '3232', 'São Paulo, SP, Brasil');
...
CREATE TABLE `mensagem_contato` (
  ...
  `passageiros_id_passageiros` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `mensagem_contato`
--

INSERT INTO `mensagem_contato` (`id_mensagem`, `conteudo_mensagem`, `email_mensagem`, `data_envio`, `status_mensagem`, `passageiros_id_passageiros`) VALUES
(3, 'Alteração de reserva.', 'maria@gmail.com', '2024-12-12 11:00:00', 'Não lida', 2),
(9, 'Problema com site.', 'lucia@gmail.com', '2024-12-12 19:30:00', 'Não lida', 8),
(10, 'Agradecimento pelo atendimento.', 'fernando@gmail.com', '2024-12-12 20:00:00', 'Respondida', 9),
(11, 'Erro no sistema de milhas.', 'claudia@gmail.com', '2024-12-12 21:15:00', 'Não lida', 10);

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `parada`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `parada` (
`id_segmento` int(11)
...
,`destino` int(11)
,`iddestino` int(11)
,`origem_aeroporto` varchar(255)
,`destino_aeroporto` varchar(255)
...
(2, 'João da Silva', 'joao.silva@gmail.com', '', '', '', '12345678901', '0000-00-00', '0'),
(8, 'Marcos Pereira', 'marcos.pereira@gmail.com', '', '', '', '78901234567', '0000-00-00', '0'),
(9, 'Lúcia Gomes', 'lucia.gomes@gmail.com', '', '', '', '89012345678', '0000-00-00', '0'),
(10, 'Fernando Costa', 'fernando.costa@gmail.com', '', '', '', '90123456789', '0000-00-00', '0'),
(34, 'Maria Oliveira', 'maria.oliveira@gmail.com', '', '', '', '23456789012', '0000-00-00', '0'),
(40, 'Carlos Souza', 'carlos.souza@gmail.com', '', '', '', '34567890123', '0000-00-00', '0'),
(55, 'Ana Paula', 'ana.paula@gmail.com', '', '', '', '45678901234', '0000-00-00', '0'),
(66, 'Juliana Santos', 'juliana.santos@gmail.com', '', '', '', '56789012345', '0000-00-00', '0'),
(71, 'Laura Pimenta de Oliveira', 'laura.p@hotmail.com', '$2y$10$7sVF5QNWVewdKbWEjrjh..0dzDsrFcUjpwTnHBB4Xj4O41vmNLn5K', '(18) 99777-8384', 'Brasil', '463.100.198-48', '2005-10-21', '0');
...
INSERT INTO `segmentovoo` (`id_segmento`, `id_voo`, `origem`, `destino`, `hora_partida`, `hora_chegada`) VALUES
(1, 1, 1, 2, '2024-12-14 19:20:00', '2024-12-19 19:20:00'),
(2, 1, 1, 2, '2024-12-25 19:32:00', '2024-12-25 18:32:00'),
(3, 1, 1, 2, '2024-12-10 19:34:00', '2024-12-12 19:32:00'),
(4, 1, 9, 10, '2004-01-26 14:50:00', '2222-01-26 14:51:00'),
(5, 7, 13, 18, '2025-04-14 14:37:00', '2025-04-14 14:38:00'),
(6, 7, 12, 16, '2025-04-14 16:38:00', '2025-04-14 20:38:00');
...
(1, 'AA1234', 1, 1, '2024-12-30 14:30:00', '2024-12-30 16:45:00', 1, 14, 'Direto', 'Reprogramado', 'Internacional'),
...
(52, '744', 8, 9, '2025-04-17 11:59:00', '2025-04-17 11:56:00', 17, 18, '', 'Suspenso', 'Nacional'),
(54, 'lalalalalalal', 13, 9, '2025-04-17 16:07:00', '2025-04-17 14:07:00', 14, 6, 'Direto', 'Desviado', 'Nacional');

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `voosview`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `voosview` (
`id_assento` int(11)
,`numero_assento` varchar(10)
,`status_assento` enum('Disponível','Ocupado','Corredor')
,`numero_voo` varchar(50)
,`id_voo` int(11)
);
...
--
-- Estrutura stand-in para view `voosview2`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `voosview2` (
`id_voo` int(11)
,`localizacao_voo` enum('Nacional','Internacional')
,`numero_voo` varchar(50)
,`data_chegada` datetime
,`data_saida` datetime
,`tipo_voo` enum('Direto','Escala')
,`aeronave_modelo` varchar(255)
,`aeronave_id` int(11)
,`localizacao_origem` varchar(255)
,`portao_numero` varchar(10)
,`portao_id` int(11)
,`origem_aeroporto` varchar(255)
,`iddestino` int(11)
,`destino_aeroporto` varchar(255)
...
,`idorigem` int(11)
,`status_voo` enum('Atrasado','No horário','Embarcando','Decolando','Cancelado','Pousando','Taxiando','Finalizado','Aguardando Autorização','Desembarcando','Manutenção','Reprogramado','Fechado','Suspenso','Em Rota','Desviado','Check-in Aberto','Portão Fechado')
,`companhiaid` int(11)
,`nome_companhia` varchar(255)
);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aeronaveview`  AS SELECT `a`.`id_aeronave` AS `id_aeronave`, `a`.`modelo_aeronave` AS `modelo_aeronave`, `a`.`capacidade_aeronave` AS `capacidade_aeronave`, `a`.`quantidade_fileiras` AS `quantidade_fileiras`, `a`.`quantidade_assentos_por_fileira` AS `quantidade_assentos_por_fileira`, `c`.`nome_companhia` AS `nome_companhia`, `c`.`id_companhia` AS `id_companhia` FROM (`aeronaves` `a` join `companhias` `c` on(`a`.`id_companhia` = `c`.`id_companhia`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `parada`
--
DROP TABLE IF EXISTS `parada`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `parada`  AS SELECT `s`.`id_segmento` AS `id_segmento`, `v`.`id_voo` AS `id_voo`, `v`.`numero_voo` AS `numero_voo`, `s`.`origem` AS `origem`, `v`.`origem_voo` AS `idorigem`, `s`.`destino` AS `destino`, `v`.`destino_voo` AS `iddestino`, `o`.`nome_aeroporto` AS `origem_aeroporto`, `d`.`nome_aeroporto` AS `destino_aeroporto`, `s`.`hora_partida` AS `hora_partida`, `s`.`hora_chegada` AS `hora_chegada` FROM (((`segmentovoo` `s` join `voos` `v` on(`s`.`id_voo` = `v`.`id_voo`)) join `aeroportos` `o` on(`s`.`origem` = `o`.`id_aeroporto`)) join `aeroportos` `d` on(`s`.`destino` = `d`.`id_aeroporto`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `voosview`
--
DROP TABLE IF EXISTS `voosview`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `voosview`  AS SELECT `a`.`id_assento` AS `id_assento`, `a`.`numero_assento` AS `numero_assento`, `a`.`status_assento` AS `status_assento`, `v`.`numero_voo` AS `numero_voo`, `v`.`id_voo` AS `id_voo` FROM (`assentos` `a` join `voos` `v` on(`a`.`id_voo` = `v`.`id_voo`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `voosview2`
--
DROP TABLE IF EXISTS `voosview2`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `voosview2`  AS SELECT `v`.`id_voo` AS `id_voo`, `v`.`localizacao_voo` AS `localizacao_voo`, `v`.`numero_voo` AS `numero_voo`, `v`.`data_chegada` AS `data_chegada`, `v`.`data_saida` AS `data_saida`, `v`.`tipo_voo` AS `tipo_voo`, `a`.`modelo_aeronave` AS `aeronave_modelo`, `a`.`id_aeronave` AS `aeronave_id`, `origem`.`localizacao_aeroporto` AS `localizacao_origem`, `p`.`numero_portao` AS `portao_numero`, `p`.`id_portao` AS `portao_id`, `origem`.`nome_aeroporto` AS `origem_aeroporto`, `v`.`destino_voo` AS `iddestino`, `destino`.`nome_aeroporto` AS `destino_aeroporto`, `destino`.`localizacao_aeroporto` AS `localizacao_destino`, `v`.`origem_voo` AS `idorigem`, `v`.`status_voo` AS `status_voo`, `a`.`id_companhia` AS `companhiaid`, `comp`.`nome_companhia` AS `nome_companhia` FROM (((((`voos` `v` join `aeronaves` `a` on(`v`.`id_aeronave` = `a`.`id_aeronave`)) join `portoes` `p` on(`v`.`id_portao` = `p`.`id_portao`)) join `aeroportos` `origem` on(`v`.`origem_voo` = `origem`.`id_aeroporto`)) join `aeroportos` `destino` on(`v`.`destino_voo` = `destino`.`id_aeroporto`)) join `companhias` `comp` on(`a`.`id_companhia` = `comp`.`id_companhia`)) ;
...
ALTER TABLE `voos`
  ...
  ADD KEY `origem_voo` (`origem_voo`),
  ADD KEY `destino_voo` (`destino_voo`);
...
--
ALTER TABLE `aeronaves`
  MODIFY `id_aeronave` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de tabela `aeroportos`
--
ALTER TABLE `aeroportos`
  MODIFY `id_aeroporto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT de tabela `assentos`
--
ALTER TABLE `assentos`
  MODIFY `id_assento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=292;

--
-- AUTO_INCREMENT de tabela `companhias`
--
ALTER TABLE `companhias`
  MODIFY `id_companhia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `passageiros`
  MODIFY `id_passageiros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT de tabela `passagens`
--
ALTER TABLE `passagens`
  MODIFY `id_passagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `portoes`
--
ALTER TABLE `portoes`
  MODIFY `id_portao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `segmentovoo`
  MODIFY `id_segmento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `terminais`
--
ALTER TABLE `terminais`
  MODIFY `id_terminal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de tabela `voos`
--
ALTER TABLE `voos`
  MODIFY `id_voo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
ALTER TABLE `segmentovoo`
  ...
  ADD CONSTRAINT `segmentovoo_ibfk_2` FOREIGN KEY (`origem`) REFERENCES `aeroportos` (`id_aeroporto`),
...
--
ALTER TABLE `terminais`
  ADD CONSTRAINT `terminais_ibfk_1` FOREIGN KEY (`id_aeroporto`) REFERENCES `aeroportos` (`id_aeroporto`);
...
ALTER TABLE `voos`
  ...
  ADD CONSTRAINT `voos_ibfk_3` FOREIGN KEY (`origem_voo`) REFERENCES `aeroportos` (`id_aeroporto`),
  ADD CONSTRAINT `voos_ibfk_4` FOREIGN KEY (`destino_voo`) REFERENCES `aeroportos` (`id_aeroporto`);
COMMIT;
