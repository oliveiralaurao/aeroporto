...
<header class="hero">
    <nav class="nav container">
        ...
        <ul class="nav-links">
            ...
            <?php if ($_SESSION['tipo_usuario'] === '1'): ?>
                <a href="./app/views/ctrldev/" class="login-btn">Controle</a>
            <?php endif ?>
        </ul>
        <li>
            <?php if (isset($_SESSION['usuario_id'])): ?>
                <a href="/aeroporto/perfil" class="login-btn">Perfil</a>
    ...
    <div class="hero-content container">
        ...
        <a href="/aeroporto#listavoos" class="confira">Confira Agora<i class="fa-solid fa-arrow-down"></i></a>
    </div>
</header>
        ...
        <?php else : ?>
            <?php foreach ($_SESSION['voos_busca'] as $voo) : ?>
                <div class="flight-card">
                    ...
                    <?php if (isset($_SESSION['usuario_id'])): ?>
                        <a href="app/views/public/mapa_assentos.php?id_voo=<?= $voo['id_voo'] ?>">Ver mapa de assentos</a>
                    <?php else: ?>
                        <a href="/aeroporto/login">Faça login para ver o mapa de assentos</a>
                    <?php endif; ?>
