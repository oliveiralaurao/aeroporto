...
<main>
    ...
    <div class="form-container" id='formulario' onsubmit="return validarDataChegadaCadastro()">
        <h2>Cadastrar Voo</h2>
    ...
    <div class="form-container" id='formulario'>
        <h2>Editar Voo</h2>
        <form method="post" action="../routes/vooRoutes.php" onsubmit="return validarDataChegadaEdicao()">
...
<script>
    ...
    function validarDataChegadaCadastro() {
        ...
        if (dataChegada && dataSaida && new Date(dataChegada) < new Date(dataSaida)) {
            alert('A data e hora de chegada não podem ser anteriores à data e hora de saída.');
    ...
    function validarDataChegadaEdicao() {
        const dataSaida = document.getElementById('data_saida_edit').value;
        const dataChegada = document.getElementById('data_chegada_edit').value;
        console.log('oi')
        if (dataChegada && dataSaida && new Date(dataChegada) < new Date(dataSaida)) {
            alert('A data e hora de chegada não podem ser anteriores à data e hora de saída.');
